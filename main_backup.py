...
class MEVBot:
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("🚀 Inicializando BOT MEV...")
            ...
            if BotConfig.DRY_RUN:
                logger.warning("🎭 MODO DRY RUN ATIVO - Nenhuma transação real será executada!")
...
{Fore.YELLOW}
    Flash Loan Arbitrage Bot com IA Adaptativa
    Versão 1.0.0 - Otimizado para Base, Arbitrum e BSC
